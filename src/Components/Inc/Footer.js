...
function Footer() {
    return (
        <section className='bg-dark text-white py-5' class = 'navCol'>
            <div className='container' >
                <div className='row'>
                    ...
                    <div className='col-md-4'>
                        ...
                        <hr />
                        <div align="center" class='text-hover'><Link to="/" className='text-decoration-none text-light'>Home</Link></div>
                        <div align="center"><Link to="/about" className='text-decoration-none text-light'>Fuel Delivery</Link></div>
                        <div align="center"><Link to="/gaspipeline" className='text-decoration-none text-light'>Gas Pipeline Connection</Link></div>
                        <div align="center"><Link to="/contact" className='text-decoration-none text-light'>Contact Us</Link></div>
